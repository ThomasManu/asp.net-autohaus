    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_herstellers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Baujahr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Preis = table.Column<double>(type: "float", nullable: false),
                    Leistung = table.Column<int>(type: "int", nullable: false),
                    TüvBis = table.Column<DateOnly>(type: "date", nullable: false),
                    Autobild = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    JsonBilderListe = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BildPfad = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Extras = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Bilderliste = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_autos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_autos_herstellers_HerstellerId",
                        column: x => x.HerstellerId,
                        principalTable: "herstellers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
